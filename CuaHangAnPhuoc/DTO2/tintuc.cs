...
namespace DTO
{
    ...
    {
        int id;
        string matintuc, tentintuc, noidung, hinhanhdaidien;
        DateTime ngaydang;
        bool enable, popular;
        public tintuc() { }
        public tintuc(int id, string matintuc, string tentintuc, string noidung, DateTime ngaydang, string hinhanhdaidien, bool enable, bool popular)
        {
            Id = id;
            Matintuc = matintuc;
            Tentintuc = tentintuc;
